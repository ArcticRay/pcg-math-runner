...
public abstract class Decorator : MonoBehaviour
{
    ...
    public abstract void DecorateChunk(Mesh chunkMesh, TerrainChunkGenerator chunkGenerator, WorldGenerationParameters parameters);
    ...
    public Tuple<GameObject, int> RandomGameObject(TerrainChunkGenerator parent, System.Random randomNumberGenerator, Vector3 position, Quaternion rotation, params GameObject[] gameObjects)
    {
